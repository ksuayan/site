...
(function() {
  ...
  gb.ui.Chart.prototype.init = function() {
    return this.data = gb.util.RandomArray(this.numberOfBars, this.generatorIndex * 100);
  };
  ...
  gb.ui.Chart.prototype.animate = function() {
    ...
    newData = gb.util.RandomArray(this.numberOfBars, this.generatorIndex * this.roundUpTo);
