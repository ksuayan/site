...
Handlebars.registerPartial("gridCell", Handlebars.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<td id=\"grid-"
    + container.escapeExpression(((helper = (helper = helpers.cellName || (depth0 != null ? depth0.cellName : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"cellName","hash":{},"data":data}) : helper)))
    + "\">&nbsp;</td>";
},"useData":true}));
...
Handlebars.registerPartial("gridHeaders", Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<thead>\n<tr>\n    <td></td>\n"
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.gridHeaders : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "</tr>\n</thead>";
},"useData":true}));
...
Handlebars.registerPartial("gridRows", Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.gridRows : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
...
this["JST"]["handlebars/gridGroups.hbs"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "  <h2>"
    + container.escapeExpression(((helper = (helper = helpers.groupName || (depth0 != null ? depth0.groupName : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"groupName","hash":{},"data":data}) : helper)))
    + "</h2>\n  <table class=\"table\">\n"
  ...
  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.gridList : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
},"usePartial":true,"useData":true});
...
gb.ui.Timeline.include({
    ...
    drawHeader: function(dataPoint) {
        var headerStyle = {"fill":"#fff","font-size":"32pt","text-anchor":"start","font-family":"IBM Plex Sans"};
        var subheadStyle = {"fill":"#fff","font-size":"16pt","text-anchor":"start","font-family":"IBM Plex Sans"};
        var subhead2Style = {"fill":"#fff","font-size":"16pt","text-anchor":"start","font-family":"IBM Plex Sans"};
        if (this.title) {
            this.title.remove();
        }
    ...
    drawTicks: function() {
        var dateStyle = { "fill":"#fff","font-size":"10pt","font-family":"IBM Plex Sans"};
    ...
    drawDate: function(timestamp) {
        var monthStyle = { "opacity": 0, "fill" : "#fff", "font-size": "16pt", "font-family" : "IBM Plex Sans" };
        var yearStyle = { "opacity": 0, "fill" : "#fff", "font-size": "12pt", "font-family" : "IBM Plex Sans" };
